...
import (
	...
	"github.com/SnareChops/6502-tools/visuals"
...
func (g *Game) Draw(screen *ebiten.Image) {
	...
	err = screen.DrawImage(visuals.Image6502, visuals.Image6502Options)
	if err != nil {
		panic(err)
	}
	err = screen.DrawImage(visuals.Button("Next"), &ebiten.DrawImageOptions{GeoM: {}})
}
