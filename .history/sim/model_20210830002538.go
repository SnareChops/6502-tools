...
import (
	"github.com/SnareChops/6502-tools/bit"
)
...
func (m *Model) Pin(i int) bool {
	...
	case 8:
		return true
	case 9:
		return bit.FromByte(m.A).Get(0)
	case 10:
		return bit.FromByte(m.A).Get(1)
	case 11:
		return bit.FromByte(m.A).Get(2)
	case 12:
		return bit.FromByte(m.A).Get(3)
	case 13:
		return bit.FromByte(m.A).Get(4)
	case 14:
		return bit.FromByte(m.A).Get(5)
	case 15:
		return bit.FromByte(m.A).Get(6)
	case 16:
		return bit.FromByte(m.A).Get(7)
	case 17:
		return bit.FromByte(m.A).Get(8)
	case 18:
		return bit.FromByte(m.A).Get(9)
	case 19:
		return bit.FromByte(m.A).Get(10)
	case 20:
		return bit.FromByte(m.A).Get(11)
	case 21:
		return bit.FromByte(m.A).Get(12)
	case 22:
		return bit.FromByte(m.A).Get(13)
	case 23:
		return bit.FromByte(m.A).Get(14)
	case 24:
		return bit.FromByte(m.A).Get(15)
	}
}
